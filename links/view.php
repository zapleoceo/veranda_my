...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/links_index.css?v=20260504_0018">
</head>
<body>
            ...
            <div class="links-hero__inner">
                ...
                <div class="links-layout">
                    <?php foreach ($sectionView as $section): ?>
                        ...
                        <?php else: ?>
                            <section class="links-section links-section--<?= htmlspecialchars((string)($section['key'] ?? '')) ?>">
    ...
    <script src="/links/links_fx.js?v=20260504_0018" defer></script>
</body>
</html>
