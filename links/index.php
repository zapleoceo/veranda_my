...
$icons = [
    ...
    'reserve' => '<svg viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M22 6H2V4h20v2Zm-2 2v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8h16ZM6 10v8h12v-8H6Zm2 4h8v2H8v-2ZM4 18h16v2H4v-2ZM11 11h2v3h-2zM11 15h2v3h-2zM7 11h2v3H7zM7 15h2v3H7zM15 11h2v3h-2zM15 15h2v3h-2z"/></svg>',
