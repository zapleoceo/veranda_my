...
<head>
    ...
    <style>
        ...
        .mid-col { display:flex; flex-direction: column; align-items:center; justify-content:flex-start; gap: 10px; padding: 10px 8px 12px; margin-top: 6px; border-radius: 14px; background: rgba(255,255,255,0.504); backdrop-filter: blur(6px); border: 1px solid rgba(208,213,221,0.6); position: relative; z-index: 3; }
    ...
    const drawLines = () => {
        ...
        links.forEach((l) => {
            ...
            if (btn) {
                ...
                const insetPx = 18;
                const tBtn = Math.min(0.95, Math.max(0.55, 1 - (insetPx / lenBtn)));
