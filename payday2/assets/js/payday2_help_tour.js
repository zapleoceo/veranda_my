(() => {
    ...
    const steps = [
        ...
        },
        {
            ...
            selector: '#midCol',
            title: 'Связи (IN)',
            text: 'Блок управления связями.\n\nТут отображаются суммы выделенных чеков и разница между ними. Кнопки ниже позволяют: связать выделенное вручную (🎯), скрыть связанные (👁), запустить автосвязь (🧩) или разорвать ошибочную связь (⛓️‍💥).',
        },
        {
            key: 'posterChecks',
            tab: 'in',
        ...
        },
        {
            ...
            text: 'Фактические списания. В красных строках доступен «+» рядом с суммой — создать транзакцию в Poster. Кнопка «−» слева — скрыть строку как «не чек».',
        },
        {
            key: 'outReloadMail',
            tab: 'out',
        ...
        },
        {
            ...
            selector: '#outMidCol',
            title: 'Связи (OUT)',
            text: 'Блок управления связями в режиме OUT.\n\nПоказывает суммы выделенных строк в левой и правой таблицах и их разницу. Кнопками можно вручную связать выделенное, скрыть связанные, автосвязать за день или разорвать связь.',
        },
        {
            key: 'financeBlock',
            tab: 'in',
