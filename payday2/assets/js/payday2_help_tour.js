(() => {
    ...
    const steps = [
        ...
        },
        {
            ...
            selector: '#midCol',
            title: 'Связи (IN)',
            text: 'Блок управления связями: связывать выбранные строки, скрывать уже связанные, автосвязывать и разрывать связи.',
        },
        {
            key: 'posterChecks',
            tab: 'in',
        ...
        },
        {
            ...
            selector: '#outMidCol',
            title: 'Связи (OUT)',
            text: 'Блок управления связями в режиме OUT: связывает списания с транзакциями Poster.',
        },
        {
            key: 'financeBlock',
            tab: 'in',
