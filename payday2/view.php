...
$payday2AssetVersion = '20260419_0022';
$payday2ClientConfig = [
            ...
            <div class="tabs">
                ...
                <div class="pd2-ml-auto pd2-d-flex">
                    <button type="button" class="tab pd2-tab-gold pd2-d-flex pd2-align-center pd2-justify-center" id="btnKashShift" style="padding: 4px 10px; background: #f97316;" title="KashShift">
                        <img src="/img/Cash.png" alt="KashShift" style="width: 20px; height: 20px; object-fit: contain;">
                    </button>
                    <button type="button" class="tab pd2-tab-gold pd2-ml-5 pd2-d-flex pd2-align-center pd2-justify-center" id="btnSupplies" style="padding: 4px 10px; background: #f97316;" title="Supplies">
                        <img src="/img/Supply.png" alt="Supplies" style="width: 20px; height: 20px; object-fit: contain;">
                    </button>
                </div>
            </div>
