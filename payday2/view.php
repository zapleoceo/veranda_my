...
$payday2AssetVersion = '20260419_0021';
$payday2ClientConfig = [
            ...
            <div class="tabs">
                ...
                <div class="pd2-ml-auto pd2-d-flex">
                    <button type="button" class="tab pd2-tab-gold pd2-d-flex pd2-align-center pd2-justify-center" id="btnKashShift" style="padding: 4px 10px; background: #f97316;" title="KashShift">
                        <img src="https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=solid%20black%20silhouette%20cash%20register%20machine%20icon%2C%20minimalist%20flat%20vector%2C%20white%20background&image_size=square" alt="KashShift" style="width: 20px; height: 20px; object-fit: contain; filter: invert(1); mix-blend-mode: screen; opacity: 0.9;">
                    </button>
