...
$v = '20260608m'; // cache-bust (золотистая палитра + eyebrow-подложка)
?>
<head>
<meta charset="UTF-8">
...
<?php foreach ($seo->alternates() as $loc => $url): ?>
<link rel="alternate" hreflang="<?= Html::e($loc) ?>" href="<?= Html::e($url) ?>">
<?php endforeach; ?>
<link rel="alternate" hreflang="x-default" href="<?= Html::e($seo->xDefault()) ?>">

<link rel="icon" type="image/svg+xml" href="/links/favicon.svg">

<meta property="og:type" content="website">
<meta property="og:site_name" content="Veranda">
<meta property="og:locale" content="<?= Html::e($seo->ogLocale()) ?>">
