...
<head>
    ...
    <style>
        :root { --bg:#0f1117; --surface:#1a1d27; --border:#2a2d3a; --text:#e2e8f0; --muted:#6b7280; --accent:#B88746; --card:var(--surface); --accent2:rgba(184,135,70,.15); }
        ...
        .nav-left a { color:var(--muted); text-decoration:none; }
