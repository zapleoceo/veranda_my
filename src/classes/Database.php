...
class Database {
    ...
    public function __construct(string $host, string $db, string $user, string $pass, string $tableSuffix = '') {
        ...
        try {
            ...
            // Смещение считаем ЗДЕСЬ, своим статическим помощником, а не
            // обращением к инфраструктурному классу подключения.
            //
            ...
            //
            // Небольшое дублирование с одноимённым помощником в новом
            // инфраструктурном классе подключения здесь осознанное: это цена
            // независимости легаси-класса от автозагрузчика. Совпадение
            // значений стережёт тест LegacyDatabaseStandaloneTest.
