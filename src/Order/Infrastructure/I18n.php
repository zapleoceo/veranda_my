    ...
    public static function all(): array
    {
        return [
            ...
            'ru' => [
                ...
                'openCheckOnePrompt'  => '⚠️ На столе уже открыт чек — выберите режим:',
                'openCheckManyPrompt' => '⚠️ На столе уже открыто {n} чека/-ов — выберите режим:',
                'openCheckPickFirst'  => 'Сначала выберите режим: новый заказ или к существующему чеку',
            ...
            'en' => [
                ...
                'openCheckOnePrompt'  => '⚠️ Open check on this table — pick a mode:',
                'openCheckManyPrompt' => '⚠️ {n} open checks on this table — pick a mode:',
                'openCheckPickFirst'  => 'Pick a mode first: new order or add to an existing check',
            ...
            'vi' => [
                ...
                'openCheckOnePrompt'  => '⚠️ Bàn này đang có hoá đơn mở — chọn chế độ:',
                'openCheckManyPrompt' => '⚠️ Bàn này đang có {n} hoá đơn mở — chọn chế độ:',
                'openCheckPickFirst'  => 'Vui lòng chọn: đơn mới hay thêm vào hoá đơn đang mở',
