...
final class WeeklyProgram
{
    ...
    public function __construct(private readonly int $today, string $reserveUrl)
    {
        $this->byDay = [
            ...
            5 => new Event('Live Music',         '19:00',         'BiBi Duo / MRV / TN Band',       'hero-lanterns', $reserveUrl),
            6 => new Event('Живая музыка',       '19:00',         'The Pennywort, Рядновы и др.',   'mountain-view', $reserveUrl),
            0 => new Event('Вечер живой музыки', '19:00',         'Уютный воскресный вечер',        'gazebo-outside', $reserveUrl),
        ];
    }
