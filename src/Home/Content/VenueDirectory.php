    ...
    public function worlds(): array
    {
        ...
        return [
            ...
            new Venue(
                ...
                titleHtml: 'Детские праздники и <em>игровая</em> зона',
                lead: 'Пока взрослые на играх или в бане — у детей свой мир: игровая '
                    . 'комната, аниматоры, шары и фотозона, дни рождения под ключ. '
                    . 'Праздники устраивает команда «Ananas party».',
                tags: ['Аниматоры', 'Игровая комната', 'Дни рождения', 'Фотозона', 'Шоу'],
                images: ['kids-1'],
                imageAlt: 'Детская игровая зона — игрушки, шары, фотозона',
