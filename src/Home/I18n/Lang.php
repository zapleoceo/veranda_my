...
final class Lang
{
    ...
    private const DICT = [
        ...
        'en' => [
            ...
            // FAQ — видимый блок «Вопросы и ответы» + источник FAQPage-разметки
            'faq.eyebrow' => 'FAQ',
            'faq.title' => 'Questions & <em>answers</em>',
            'faq.q1' => "What are Veranda's opening hours?",
            'faq.a1' => 'Mon–Thu 10:00–22:00, Fri–Sun 10:00–23:00.',
            'faq.q2' => 'Do I need to book a table?',
            'faq.a2' => "It's not required, but we're always glad to take a booking.",
            'faq.q3' => 'Is there parking?',
            'faq.a3' => 'Yes, there is parking on site.',
            'faq.q4' => 'Are pets allowed?',
            'faq.a4' => 'Yes, pets are welcome.',
            'faq.q5' => 'What cuisine do you serve?',
            'faq.a5' => 'Home cooking with a European and Russian accent.',
            'faq.q6' => 'Do you have vegetarian dishes?',
            'faq.a6' => 'Yes, there are vegetarian dishes on the menu.',
            'faq.q7' => 'What is the average bill?',
            'faq.a7' => '100,000–200,000 VND per person.',
            'faq.q8' => 'Where is the restaurant?',
            'faq.a8' => 'Trần Khát Chân, Đường Đệ, north Nha Trang, by Hon Chong hill.',
        ],
        ...
        'ru' => [
            ...
            'faq.title' => 'Вопросы и <em>ответы</em>',
            'faq.q1' => 'Какие часы работы Veranda?',
            'faq.a1' => 'Пн–Чт с 10:00 до 22:00, Пт–Вс с 10:00 до 23:00.',
            'faq.q2' => 'Нужна ли бронь столика?',
            'faq.a2' => 'Не обязательна, но по желанию с радостью примем бронь.',
            'faq.q3' => 'Есть ли парковка?',
            'faq.a3' => 'Да, парковка на месте.',
            'faq.q4' => 'Можно ли с животными?',
            'faq.a4' => 'Да, с питомцами можно.',
            'faq.q5' => 'Какая кухня в ресторане?',
            'faq.a5' => 'Домашняя кухня с европейским и русским акцентом.',
            'faq.q6' => 'Есть ли вегетарианские блюда?',
            'faq.a6' => 'Да, в меню есть вегетарианские блюда.',
            'faq.q7' => 'Какой средний чек?',
            'faq.a7' => '100 000–200 000 донгов на человека.',
            'faq.q8' => 'Где находится ресторан?',
            'faq.a8' => 'Trần Khát Chân, Đường Đệ, север Нячанга, у горы Хон Чонг.',
        ],
        ...
        'vi' => [
            ...
            'faq.title' => 'Hỏi & <em>đáp</em>',
            'faq.q1' => 'Veranda mở cửa giờ nào?',
            'faq.a1' => 'Thứ 2–Thứ 5: 10:00–22:00, Thứ 6–Chủ nhật: 10:00–23:00.',
            'faq.q2' => 'Có cần đặt bàn trước không?',
            'faq.a2' => 'Không bắt buộc, nhưng chúng tôi luôn sẵn sàng nhận đặt bàn.',
            'faq.q3' => 'Có chỗ đậu xe không?',
            'faq.a3' => 'Có, có chỗ đậu xe ngay tại chỗ.',
            'faq.q4' => 'Có cho mang thú cưng không?',
            'faq.a4' => 'Có, bạn có thể mang theo thú cưng.',
            'faq.q5' => 'Nhà hàng phục vụ ẩm thực gì?',
            'faq.a5' => 'Món ăn nhà làm mang phong vị châu Âu và Nga.',
            'faq.q6' => 'Có món chay không?',
            'faq.a6' => 'Có, trong thực đơn có món chay.',
            'faq.q7' => 'Chi phí trung bình bao nhiêu?',
            'faq.a7' => '100.000–200.000 VND mỗi người.',
            'faq.q8' => 'Nhà hàng ở đâu?',
            'faq.a8' => 'Trần Khát Chân, Đường Đệ, phía bắc Nha Trang, gần núi Hòn Chồng.',
        ],
    ];
}
