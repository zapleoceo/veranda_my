...
/*
TR4 (Booking) — Developer Note

Purpose: TR4 is a standalone booking page. Keep it clean and maintainable.
...
- Controller: /tr4/api.php is the only entrypoint for AJAX. Keep controllers thin.
...
- No coupling with previous versions (do not import/require old pages; do not reuse legacy names like “tr2” in TR4 assets).
- TR4 assets must live in /tr4/assets with neutral names (app.js, base.css, layout.css, tr4.css, etc.).
*/
...
$self = strtok((string)($_SERVER['REQUEST_URI'] ?? '/tr4/'), '?');
$params = $_GET;
...
<head>
  ...
  <link rel="canonical" href="https://veranda.my/tr4?lang=<?= urlencode($lang) ?>">
  ...
  <meta property="og:url" content="https://veranda.my/tr4?lang=<?= urlencode($lang) ?>">
  ...
  <link rel="stylesheet" href="/tr4/assets/tr3.css?v=20260509_0410">
  <noscript>
    <style>
...
<body>
  ...
  <div class="modal" id="reqModal" aria-hidden="true">
    ...
    <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="reqModalTitle" id="reqModalCard">
      ...
      <form id="reqForm" method="post" action="/tr4/api.php?ajax=submit_booking" accept-charset="utf-8" novalidate>
        ...
        <div class="req-toast" id="reqToast" hidden></div>
        <div class="modal-actions">
  ...
  <script type="application/ld+json"><?= json_encode([
    ...
    '@type' => 'Restaurant',
    'name' => 'Veranda',
    'url' => 'https://veranda.my/tr4?lang=' . $lang,
    'potentialAction' => [
      '@type' => 'ReserveAction',
      'target' => [
        '@type' => 'EntryPoint',
        'urlTemplate' => 'https://veranda.my/tr4?lang=' . $lang,
      ],
    ],
  ], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?></script>
  <script src="/tr4/assets/tr3.boot.js?v=20260509_0410" defer></script>
